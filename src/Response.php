...
class Response implements ResponseInterface
{
        ...
        if ($this->headers === null) {
            ...
            if (!empty($this->rawHeaders)) {
                ...
                foreach ($headers as $header) {
                    ...
                    $nameParts = array_map(function ($value) {
     ...
     * @author Verdient。
     */
    protected function getParsers(?string $contentType = null, ?string $charset = null): Iterator
    {
        if ($this->request->getParser()) {
            ...
            if (!empty($contentType) && isset(static::BUILT_IN_PARSERS[$contentType])) {
            ...
            if (isset($headers['Content-Type'])) {
                ...
                if (!empty($contentType)) {
                    if ($pos = strpos($contentType, '; ')) {
                        $contentType = substr($contentType, $pos + 2);
                    }
